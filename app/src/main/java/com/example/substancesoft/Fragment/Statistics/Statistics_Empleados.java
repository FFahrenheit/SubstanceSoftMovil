...
public class Statistics_Empleados extends Fragment
{
    ...
    {
        View view = inflater.inflate(R.layout.fragment_statistics__empleados,container,false);

        webView = (WebView) view.findViewById(R.id.WebView);
        webView.getSettings().setJavaScriptEnabled(true);
        String url = "http://"+getResources().getString(R.string.address)+"/substancesoft/mobile/participacion.php";
        webView.loadUrl(url);
